    ...
    <div className="relative min-h-screen bg-white dark:bg-black">
      ...
      <main className="relative z-10 px-4 py-20 md:py-32 text-center">
        ...
        <motion.div
          ...
          className="mt-20 mx-auto max-w-6xl overflow-hidden rounded-3xl border border-neutral-200 bg-neutral-100 shadow-md dark:border-neutral-800 dark:bg-neutral-900"
        >
          <img
            src="/coomingsoon.png"
            alt="Landing preview"
  ...
  return (
    <nav className="flex w-full items-center justify-between border-y border-neutral-200 px-4 py-4 dark:border-neutral-800">
      <div className="flex items-center gap-2">
        <a href="https://www.fontspace.com/category/square">
          <img
            src="https://see.fontimg.com/api/rf5/32mL/MmU1MWMyZjg4MjcyNGM5NGI5NDczOWFkYzBhZjgxNzEudHRm/UnVtZQ/reformation-sans-regular.png?r=fs&h=65&w=1000&fg=000000&bg=FFFFFF&tb=1&s=65"
            alt="Square fonts"
            className="w-20"
          />
        </a>
